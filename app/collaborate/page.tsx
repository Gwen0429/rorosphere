...
import { collaborateItems } from '@/src/data/collaborate';
  ...
  return (
    <>
      <style>{`
        ...
        ul.collaborate-list li:last-child {
          border-bottom: none;
        }

        ul.collaborate-list h3 {
          margin: 0 0 8px;
          font-weight: 700;
          font-size: 1.6rem;
          color: #A8874E;
        ...
        ul.collaborate-list h3 a:focus {
          color: var(--champagne-gold);
          outline: none;
          text-decoration: none;
        }

        ul.collaborate-list p {
          margin: 0 0 8px;
          font-weight: 300;
          font-size: 1.1rem;
          color: #6b6b6bdd;
      ...
      <main>
        ...
        <ul className="collaborate-list" aria-label="Collaboration Opportunities">
          {collaborateItems.map(({ id, title, description, date, link }) => (
            <li key={id}>
              <h3>
